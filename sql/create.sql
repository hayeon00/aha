...
CREATE TABLE `problem` (
                           ...
                           INDEX `idx_problem_exam_id` (`exam_id`),
                           INDEX `idx_problem_scope_node_id` (`exam_scope_node_id`),
                           INDEX `idx_problem_ai_generated_problem_id` (`ai_generated_problem_id`),

                           CONSTRAINT `fk_problem_exam_id`
                               FOREIGN KEY (`exam_id`) REFERENCES `exam` (`id`)
                                   ON DELETE CASCADE,

                           CONSTRAINT `fk_problem_exam_version_id`
                               FOREIGN KEY (`exam_version_id`) REFERENCES `exam_version` (`id`)
                                   ON DELETE CASCADE,
                           ...
                           CONSTRAINT `fk_problem_ai_generated_problem_id`
                               FOREIGN KEY (`ai_generated_problem_id`) REFERENCES `ai_generated_problem` (`id`)
                                   ON DELETE SET NULL
);
...
CREATE TABLE `problem_available_usage_type` (
                                                ...
                                                INDEX `idx_paut_problem_id` (`problem_id`),
                                                INDEX `idx_paut_domain_type_id` (`domain_type_id`),

                                                CONSTRAINT `fk_paut_problem_id`
                                                    FOREIGN KEY (`problem_id`) REFERENCES `problem` (`id`)
                                                        ON DELETE CASCADE,

                                                CONSTRAINT `fk_paut_domain_type_id`
                                                    FOREIGN KEY (`domain_type_id`) REFERENCES `domain_type` (`id`)
                                                        ON DELETE CASCADE
);
