...
import com.aha.domain.ailearn.document.service.generation.LearningContentGenerationService;
...
public class DocumentProcessingWorkerService {
    ...
    private void mapDocumentScopes(Long processingGroupId) {
        ...
        scopeMappingService.mapDocuments(processingGroupId);
    ...
    private void generateLearningContents(Long processingGroupId) {
        ...
        contentGenerationService.generateLearningContents(processingGroupId);
