...
import com.aha.domain.document.client.mapping.dto.ScopeMappingAiResponse;
...
public class DocumentScopeMappingResponseParser {
     ...
     */
    public List<ScopeMappingAiResult> parse(
            String aiResponse
    ) {
        ...
        try {
            ScopeMappingAiResponse response =
                    objectMapper.readValue(
                            normalizedResponse,
                            ScopeMappingAiResponse.class
                    );
    ...
    private void validateResponse(
         ...
         * 빈 배열은 정상 응답으로 허용한다.
         */
        for (ScopeMappingAiResult mapping
                : response.mappings()) {
